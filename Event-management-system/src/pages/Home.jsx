...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-10 ">
      <div className="container h-auto lg:h-screen m-auto flex flex-col lg:flex-row items-center justify-center px-6 sm:px-10 lg:px-6 py-12 gap-y-10 lg:gap-x-16">
        {/* Left Side: Content */}
        ...
        <div className="w-full lg:w-1/2 ">
          <img
            ...
            alt="Event Planning"
            className="w-full object-cover h-auto rounded-2xl shadow-xl transition duration-500 ease-in-out"
          />
        </div>
      </div>
    </div>
